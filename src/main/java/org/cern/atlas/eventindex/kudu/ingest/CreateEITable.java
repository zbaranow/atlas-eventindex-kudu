...
columns.add(new ColumnSchema.ColumnSchemaBuilder("issimulation", Type.BOOL).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
columns.add(new ColumnSchema.ColumnSchemaBuilder("iscalibration", Type.BOOL).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
columns.add(new ColumnSchema.ColumnSchemaBuilder("istestbeam", Type.BOOL).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
