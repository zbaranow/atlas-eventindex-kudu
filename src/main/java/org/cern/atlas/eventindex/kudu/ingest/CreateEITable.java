...
columns.add(new ColumnSchema.ColumnSchemaBuilder("lumiblockn", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
columns.add(new ColumnSchema.ColumnSchemaBuilder("bunchid", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
columns.add(new ColumnSchema.ColumnSchemaBuilder("eventtime", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
columns.add(new ColumnSchema.ColumnSchemaBuilder("eventtimenanosec", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
...
columns.add(new ColumnSchema.ColumnSchemaBuilder("mcchannelnumber", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
...
columns.add(new ColumnSchema.ColumnSchemaBuilder("issimulation", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
columns.add(new ColumnSchema.ColumnSchemaBuilder("iscalibration", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
columns.add(new ColumnSchema.ColumnSchemaBuilder("istestbeam", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
...
columns.add(new ColumnSchema.ColumnSchemaBuilder("smk", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
columns.add(new ColumnSchema.ColumnSchemaBuilder("hltpsk", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
columns.add(new ColumnSchema.ColumnSchemaBuilder("l1psk", Type.INT32).encoding(ColumnSchema.Encoding.BIT_SHUFFLE).nullable(true).compressionAlgorithm(ColumnSchema.CompressionAlgorithm.SNAPPY).build());
